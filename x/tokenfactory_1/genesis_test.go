...
import (
	...
	"github.com/strangelove-ventures/noble/x/tokenfactory_1"
...
func TestGenesis(t *testing.T) {
	...
	k, ctx := keepertest.TokenfactoryKeeper_1(t)
	tokenfactory_1.InitGenesis(ctx, k, keepertest.MockBankKeeper{}, genesisState)
	got := tokenfactory_1.ExportGenesis(ctx, k)
