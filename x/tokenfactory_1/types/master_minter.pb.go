...
// source: tokenfactory_1/master_minter.proto
...
func init() {
	proto.RegisterType((*MasterMinter)(nil), "noble.tokenfactory_1.MasterMinter")
}

func init() {
	proto.RegisterFile("tokenfactory_1/master_minter.proto", fileDescriptor_c479f9fd1b6e6993)
}
