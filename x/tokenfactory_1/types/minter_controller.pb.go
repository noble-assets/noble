...
// source: tokenfactory_1/minter_controller.proto
...
func init() {
	proto.RegisterType((*MinterController)(nil), "noble.tokenfactory_1.MinterController")
}

func init() {
	proto.RegisterFile("tokenfactory_1/minter_controller.proto", fileDescriptor_495bb092931b2550)
}
