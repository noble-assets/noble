...
// source: tokenfactory_1/owner.proto
...
func init() {
	proto.RegisterType((*Owner)(nil), "noble.tokenfactory_1.Owner")
}

func init() { proto.RegisterFile("tokenfactory_1/owner.proto", fileDescriptor_e2c4cb5978da9c0c) }
