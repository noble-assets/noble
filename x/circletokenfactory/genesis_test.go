package circletokenfactory_test
...
import (
	...
	circletokenfactory "github.com/strangelove-ventures/noble/x/circletokenfactory"
...
func TestGenesis(t *testing.T) {
	...
	k, ctx := keepertest.CircleTokenfactoryKeeper(t)
	circletokenfactory.InitGenesis(ctx, k, keepertest.MockBankKeeper{}, genesisState)
	got := circletokenfactory.ExportGenesis(ctx, k)
