...
// source: circletokenfactory/minters.proto
...
func init() {
	proto.RegisterType((*Minters)(nil), "noble.circletokenfactory.Minters")
}

func init() { proto.RegisterFile("circletokenfactory/minters.proto", fileDescriptor_cc71c0fc67b5c982) }
