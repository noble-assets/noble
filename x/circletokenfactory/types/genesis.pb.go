...
// source: circletokenfactory/genesis.proto
...
// GenesisState defines the circletokenfactory module's genesis state.
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "noble.circletokenfactory.GenesisState")
}

func init() { proto.RegisterFile("circletokenfactory/genesis.proto", fileDescriptor_192e1a68f2f38605) }
