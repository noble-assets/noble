...
// source: usdc_tokenfactory/paused.proto
...
func init() {
	proto.RegisterType((*Paused)(nil), "noble.usdc_tokenfactory.Paused")
}

func init() { proto.RegisterFile("usdc_tokenfactory/paused.proto", fileDescriptor_cb025c49ec0edc56) }
