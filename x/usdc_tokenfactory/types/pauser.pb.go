...
// source: usdc_tokenfactory/pauser.proto
...
func init() {
	proto.RegisterType((*Pauser)(nil), "noble.usdc_tokenfactory.Pauser")
}

func init() { proto.RegisterFile("usdc_tokenfactory/pauser.proto", fileDescriptor_2f9e004c71a8536f) }
