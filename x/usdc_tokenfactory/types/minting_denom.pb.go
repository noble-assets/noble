...
// source: usdc_tokenfactory/minting_denom.proto
...
func init() {
	proto.RegisterType((*MintingDenom)(nil), "noble.usdc_tokenfactory.MintingDenom")
}

func init() {
	proto.RegisterFile("usdc_tokenfactory/minting_denom.proto", fileDescriptor_9b4d5db7f3cc8383)
}
