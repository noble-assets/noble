...
// source: usdc_tokenfactory/master_minter.proto
...
func init() {
	proto.RegisterType((*MasterMinter)(nil), "noble.usdc_tokenfactory.MasterMinter")
}

func init() {
	proto.RegisterFile("usdc_tokenfactory/master_minter.proto", fileDescriptor_c479f9fd1b6e6993)
}
