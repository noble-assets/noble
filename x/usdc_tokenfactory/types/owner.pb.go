...
// source: usdc_tokenfactory/owner.proto
...
func init() {
	proto.RegisterType((*Owner)(nil), "noble.usdc_tokenfactory.Owner")
}

func init() { proto.RegisterFile("usdc_tokenfactory/owner.proto", fileDescriptor_e2c4cb5978da9c0c) }
