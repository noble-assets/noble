package usdc_tokenfactory

import (
	sdkerrors "github.com/cosmos/cosmos-sdk/types/errors"
	"github.com/strangelove-ventures/noble/x/usdc_tokenfactory/keeper"
...
func InitGenesis(ctx sdk.Context, k *keeper.Keeper, bankKeeper types.BankKeeper, genState types.GenesisState) {
	...
	if genState.MintingDenom != nil {
		...
		if !found {
			panic(sdkerrors.Wrapf(types.ErrDenomNotRegistered, "usdc_tokenfactory minting denom %s is not registered in bank module denom_metadata", genState.MintingDenom.Denom))
		}
