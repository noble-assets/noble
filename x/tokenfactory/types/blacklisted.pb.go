...
func (m *Blacklisted) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
var fileDescriptor_43ff59c42df01ab4 = []byte{
	...
	,
}
...
func (m *Blacklisted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Address) > 0 {
		...
		i = encodeVarintBlacklisted(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0xa
	}
