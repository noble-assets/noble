...
func (m *Blacklisted) GetPubkey() []byte {
	if m != nil {
		return m.Pubkey
	}
	return nil
...
var fileDescriptor_43ff59c42df01ab4 = []byte{
	...
	0x49, 0xd5, 0x43, 0x56, 0xa5, 0xa4, 0xca, 0xc5, 0xed, 0x84, 0x50, 0x28, 0x24, 0xc6, 0xc5, 0x56,
	0x50, 0x9a, 0x94, 0x9d, 0x5a, 0x29, 0xc1, 0xa8, 0xc0, 0xa8, 0xc1, 0x13, 0x04, 0xe5, 0x39, 0x85,
	...
	0x59, 0xaa, 0x6e, 0x59, 0x6a, 0x5e, 0x49, 0x69, 0x51, 0x6a, 0xb1, 0x3e, 0xd8, 0x52, 0xfd, 0x0a,
	0x7d, 0x14, 0xc7, 0x95, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0xdd, 0x65, 0x0c, 0x08, 0x00,
	0x00, 0xff, 0xff, 0xa7, 0x8d, 0x09, 0x2a, 0xb9, 0x00, 0x00, 0x00,
}
...
func (m *Blacklisted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Pubkey) > 0 {
		...
		i = encodeVarintBlacklisted(dAtA, i, uint64(len(m.Pubkey)))
		i--
		dAtA[i] = 0xa
	}
