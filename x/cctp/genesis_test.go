...
func TestGenesis(t *testing.T) {
	...
	require.Equal(t, genesisState.Nonce, got.Nonce)
	require.Equal(t, genesisState.SignatureThreshold, got.MaxMessageBodySize)
	require.Equal(t, genesisState.TokenPairList, got.MaxMessageBodySize)
	require.Equal(t, genesisState.UsedNoncesList, got.MaxMessageBodySize)
}
