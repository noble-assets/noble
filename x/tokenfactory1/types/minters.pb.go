...
// source: tokenfactory1/minters.proto
...
func init() {
	proto.RegisterType((*Minters)(nil), "noble.tokenfactory1.Minters")
}

func init() { proto.RegisterFile("tokenfactory1/minters.proto", fileDescriptor_cc71c0fc67b5c982) }
