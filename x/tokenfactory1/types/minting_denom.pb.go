...
// source: tokenfactory1/minting_denom.proto
...
func init() {
	proto.RegisterType((*MintingDenom)(nil), "noble.tokenfactory1.MintingDenom")
}

func init() {
	proto.RegisterFile("tokenfactory1/minting_denom.proto", fileDescriptor_9b4d5db7f3cc8383)
}
