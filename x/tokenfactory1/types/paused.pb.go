...
// source: tokenfactory1/paused.proto
...
func init() {
	proto.RegisterType((*Paused)(nil), "noble.tokenfactory1.Paused")
}

func init() { proto.RegisterFile("tokenfactory1/paused.proto", fileDescriptor_cb025c49ec0edc56) }
