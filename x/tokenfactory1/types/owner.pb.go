...
// source: tokenfactory1/owner.proto
...
func init() {
	proto.RegisterType((*Owner)(nil), "noble.tokenfactory1.Owner")
}

func init() { proto.RegisterFile("tokenfactory1/owner.proto", fileDescriptor_e2c4cb5978da9c0c) }
