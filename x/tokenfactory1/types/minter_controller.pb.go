...
// source: tokenfactory1/minter_controller.proto
...
func init() {
	proto.RegisterType((*MinterController)(nil), "noble.tokenfactory1.MinterController")
}

func init() {
	proto.RegisterFile("tokenfactory1/minter_controller.proto", fileDescriptor_495bb092931b2550)
}
