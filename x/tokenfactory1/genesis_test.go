...
import (
	...
	tokenfactory1 "github.com/strangelove-ventures/noble/x/tokenfactory1"
...
func TestGenesis(t *testing.T) {
	...
	k, ctx := keepertest.Tokenfactory_1Keeper(t)
	tokenfactory1.InitGenesis(ctx, k, keepertest.MockBankKeeper{}, genesisState)
	got := tokenfactory1.ExportGenesis(ctx, k)
