...
import (
	...
	"noble.xyz/x/accounts/types/hyperlane"
)
...
func (c Controller) GetAddress(input *gogoproto.Any) ([]byte, error) {
	_, err := c.decodeAttributes(input)
	if err != nil {
		return nil, err
	}
...
func (c Controller) decodeAttributes(input *gogoproto.Any) (hyperlane.Attributes, error) {
	var attributes hyperlane.Attributes
