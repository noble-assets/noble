...
<<<<<<< HEAD:x/fiattokenfactory/client/cli/tx_configure_minter_controller.go
	"github.com/strangelove-ventures/noble/x/fiattokenfactory/types"
=======
>>>>>>> a4ad980 (chore: rename module path (#283)):x/stabletokenfactory/client/cli/tx_configure_minter_controller.go
)
