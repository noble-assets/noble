...
<<<<<<< HEAD:x/fiattokenfactory/simulation/remove_minter_controller.go
...
>>>>>>> a4ad980 (chore: rename module path (#283)):x/stabletokenfactory/simulation/remove_minter_controller.go
)
