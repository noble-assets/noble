...
<<<<<<< HEAD:x/fiattokenfactory/simulation/update_master_minter.go
...
>>>>>>> a4ad980 (chore: rename module path (#283)):x/stabletokenfactory/simulation/update_master_minter.go
)
