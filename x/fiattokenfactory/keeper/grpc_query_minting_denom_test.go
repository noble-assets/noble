...
<<<<<<< HEAD:x/fiattokenfactory/keeper/grpc_query_minting_denom_test.go
...
>>>>>>> a4ad980 (chore: rename module path (#283)):x/stabletokenfactory/keeper/grpc_query_minting_denom_test.go
)
