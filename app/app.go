...
import (
	...
	usdctokenfactorymodule "github.com/strangelove-ventures/noble/x/usdc_tokenfactory"
	usdctokenfactorymodulekeeper "github.com/strangelove-ventures/noble/x/usdc_tokenfactory/keeper"
	usdctokenfactorymoduletypes "github.com/strangelove-ventures/noble/x/usdc_tokenfactory/types"
)
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		usdctokenfactorymodule.AppModuleBasic{},
	...
	maccPerms = map[string][]string{
		...
		usdctokenfactorymoduletypes.ModuleName: {authtypes.Minter, authtypes.Burner, authtypes.Staking},
...
type App struct {
	*baseapp.BaseApp
	...
	UsdcTokenFactoryKeeper *usdctokenfactorymodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		tokenfactorymoduletypes.StoreKey, usdctokenfactorymoduletypes.StoreKey, packetforwardtypes.StoreKey, stakingtypes.StoreKey,
	)
	...
	app.UsdcTokenFactoryKeeper = usdctokenfactorymodulekeeper.NewKeeper(
		appCodec,
		keys[usdctokenfactorymoduletypes.StoreKey],
		app.GetSubspace(usdctokenfactorymoduletypes.ModuleName),

		app.BankKeeper,
	)
	usdctokenfactoryModule := usdctokenfactorymodule.NewAppModule(appCodec, app.UsdcTokenFactoryKeeper, app.AccountKeeper, app.BankKeeper)
	...
	transferStack = blockibc.NewIBCMiddleware(transferStack, app.TokenFactoryKeeper, app.UsdcTokenFactoryKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		usdctokenfactorymoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramauthoritykeeper.Keeper {
	...
	paramsKeeper.Subspace(usdctokenfactorymoduletypes.ModuleName)
