...
import (
	...
	"github.com/strangelove-ventures/noble/x/blockibc_middleware"
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		tokenfactorymoduletypes.StoreKey, packetforwardtypes.StoreKey, stakingtypes.StoreKey,
	)
	...
	transferStack = blockibc_middleware.NewIBCMiddleware(transferStack, app.TokenFactoryKeeper)
