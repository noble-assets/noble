...
func CreateUpgradeHandler(
	...
	return func(ctx context.Context, _ upgradetypes.Plan, vm module.VersionMap) (module.VersionMap, error) {
		...
		// In IBC-Go v8.7.0, the MsgRecoverClient message does not support
		// the LegacyAminoJSON signing mode, preventing recovery via the
		// Noble Maintenance Multisig. As a result, expired clients on mainnet
		// must be manually recovered as part of a software upgrade.
