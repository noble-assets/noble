module github.com/noble-assets/noble/v9
...
require (
	...
	jester.noble.xyz/api v0.0.0-20250110224153-143376c94717
...
replace jester.noble.xyz/api v0.0.0-20250110224153-143376c94717 => ../jester/api
