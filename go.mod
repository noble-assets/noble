...
require (
	...
	github.com/noble-assets/paramauthority v0.0.0-20230816161518-74a80f60b77f
...
replace (
	// use twilight compatible fiatokenfactory module
	github.com/circlefin/noble-fiattokenfactory => github.com/noble-assets/fiattokenfactory v0.0.0-20230803152300-ae917cbbc926
