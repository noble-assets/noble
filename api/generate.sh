...
buf export buf.build/noble-assets/authority:v1.0.1 --output api/proto
buf export buf.build/noble-assets/cctp:4285c94ec19438ad1e05ba3e5106a5e7980cfffd --output api/proto
buf export buf.build/noble-assets/dollar:v1.0.0-alpha.2 --output api/proto
...
buf export buf.build/noble-assets/forwarding:v2.0.0 --output api/proto
