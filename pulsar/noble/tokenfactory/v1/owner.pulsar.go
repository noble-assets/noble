...
func init() {
	...
	md_Owner = File_noble_tokenfactory_v1_owner_proto.Messages().ByName("Owner")
...
func (x *Owner) slowProtoReflect() protoreflect.Message {
	mi := &file_noble_tokenfactory_v1_owner_proto_msgTypes[0]
...
func (x *fastReflection_Owner) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "noble.tokenfactory.v1.Owner.address":
		return x.Address != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.tokenfactory.v1.Owner"))
		}
		panic(fmt.Errorf("message noble.tokenfactory.v1.Owner does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Owner) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message noble.tokenfactory.v1.Owner does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Owner) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "noble.tokenfactory.v1.Owner.address":
		panic(fmt.Errorf("field address of message noble.tokenfactory.v1.Owner is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.tokenfactory.v1.Owner"))
		}
...
func (x *fastReflection_Owner) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in noble.tokenfactory.v1.Owner", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: noble/tokenfactory/v1/owner.proto
...
func (*Owner) Descriptor() ([]byte, []int) {
	return file_noble_tokenfactory_v1_owner_proto_rawDescGZIP(), []int{0}
}
...
var File_noble_tokenfactory_v1_owner_proto protoreflect.FileDescriptor

var file_noble_tokenfactory_v1_owner_proto_rawDesc = []byte{
	,
...
var (
	file_noble_tokenfactory_v1_owner_proto_rawDescOnce sync.Once
	file_noble_tokenfactory_v1_owner_proto_rawDescData = file_noble_tokenfactory_v1_owner_proto_rawDesc
)

func file_noble_tokenfactory_v1_owner_proto_rawDescGZIP() []byte {
	file_noble_tokenfactory_v1_owner_proto_rawDescOnce.Do(func() {
		file_noble_tokenfactory_v1_owner_proto_rawDescData = protoimpl.X.CompressGZIP(file_noble_tokenfactory_v1_owner_proto_rawDescData)
	})
	return file_noble_tokenfactory_v1_owner_proto_rawDescData
}

var file_noble_tokenfactory_v1_owner_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_noble_tokenfactory_v1_owner_proto_goTypes = []interface{}{
	(*Owner)(nil), // 0: noble.tokenfactory.v1.Owner
}
var file_noble_tokenfactory_v1_owner_proto_depIdxs = []int32{
...
func init() { file_noble_tokenfactory_v1_owner_proto_init() }
func file_noble_tokenfactory_v1_owner_proto_init() {
	if File_noble_tokenfactory_v1_owner_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_noble_tokenfactory_v1_owner_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Owner); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_noble_tokenfactory_v1_owner_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_noble_tokenfactory_v1_owner_proto_goTypes,
		DependencyIndexes: file_noble_tokenfactory_v1_owner_proto_depIdxs,
		MessageInfos:      file_noble_tokenfactory_v1_owner_proto_msgTypes,
	}.Build()
	File_noble_tokenfactory_v1_owner_proto = out.File
	file_noble_tokenfactory_v1_owner_proto_rawDesc = nil
	file_noble_tokenfactory_v1_owner_proto_goTypes = nil
	file_noble_tokenfactory_v1_owner_proto_depIdxs = nil
}
